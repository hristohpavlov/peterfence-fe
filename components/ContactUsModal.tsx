...
const ContactUsModal = () => {
  ...
  return (
    <>
      <a className={classNames("btn card_btn btn-lg btn-outline-light text-center")} onClick={handleShow}>Get Inquiry</a>
          ...
          <div className="modal-body mx-3">
            <form onSubmit={handleSubmit}>
              ...
              <div className="modal-footer d-flex justify-content-center">
                <div className="md-form">
                  <i className="fas fa-pencil prefix grey-text"></i>
                  <input className="btn btn-unique" type="submit" value="Contact us" />
                </div>
              </div>
