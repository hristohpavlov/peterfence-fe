                ...
                <div className={classNames("container mt-5 mb-n5", styles.container_center)}>
                    ...
                    <div className={classNames("main", styles.main)}>
                        ...
                        <ul className={classNames("cards", styles.cards)}>
                            ...
                            <li className={classNames("cards_item", styles.cards_item)}>
                                <div className={classNames("card", styles.card)}>
                                    <div className={classNames("card_image", styles.card_image)}><img height="100%" width="100%" alt="privacy fence" className={classNames("img", styles.img)} src="/static/2.webp" /></div>
                                    <div className={classNames("card_content", styles.card_content)}>
                            ...
                            <li className={classNames("cards_item", styles.cards_item)}>
                                <div className={classNames("card", styles.card)}>
                                    <div className={classNames("card_image", styles.card_image)}><img height="100%" width="100%" alt="acacia fence" className={classNames("img", styles.img)} src="/static/3.webp" /></div>
                                    <div className={classNames("card_content", styles.card_content)}>
                            ...
                            <li className={classNames("cards_item", styles.cards_item)}>
                                <div className={classNames("card", styles.card)}>
                                    <div className={classNames("card_image", styles.card_image)}><img height="100%" width="100%" alt="commercial fence" className={classNames("img", styles.img)} src="/static/4.webp" /></div>
                                    <div className={classNames("card_content", styles.card_content)}>
                            ...
                            <li className={classNames("cards_item", styles.cards_item)}>
                                <div className={classNames("card", styles.card)}>
                                    <div className={classNames("card_image", styles.card_image)}><img height="100%" width="100%" alt="construction fence" className={classNames("img", styles.img)} src="/static/5.webp" /></div>
                                    <div className={classNames("card_content", styles.card_content)}>
                            ...
                            <li className={classNames("cards_item", styles.cards_item)}>
                                <div className={classNames("card", styles.card)}>
                                    <div className={classNames("card_image", styles.card_image)}><img height="100%" width="100%" alt="long-lasting fence" className={classNames("img", styles.img)} src="/static/6.webp" /></div>
                                    <div className={classNames("card_content", styles.card_content)}>
                            ...
                            <li className={classNames("cards_item", styles.cards_item)}>
                                <div className={classNames("card", styles.card)}>
                                    <div className={classNames("card_image", styles.card_image)}><img height="100%" width="100%" alt="quality fence" className={classNames("img", styles.img)} src="/static/1.webp" /></div>
                                    <div className={classNames("card_content", styles.card_content)}>
                            ...
                            <li className={classNames("cards_item", styles.cards_item)}>
                                <div className={classNames("card", styles.card)}>
                                    <div className={classNames("card_image", styles.card_image)}><img height="100%" width="100%" alt="acacia fencing" className={classNames("img", styles.img)} src="/static/4.webp" /></div>
                                    <div className={classNames("card_content", styles.card_content)}>
                            ...
                            <li className={classNames("cards_item", styles.cards_item)}>
                                <div className={classNames("card", styles.card)}>
                                    <div className={classNames("card_image", styles.card_image)}><img height="100%" width="100%" alt="pet-friendly fence" className={classNames("img", styles.img)} src="/static/5.webp" /></div>
                                    <div className={classNames("card_content", styles.card_content)}>
