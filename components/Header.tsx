        ...
        <>
            ...
            <Navbar collapseOnSelect sticky="top" expand="lg" bg="dark" variant="dark" className={classNames(scrolling ? "active" : "transparent")}>
                <Container style={{ maxWidth: "unset" }}>
                    {currTheme === 'dark' && <Navbar.Brand href="/" aria-label="Home Page Navigation Button"><img alt="company logo dark" src="/static/peterfence-only-logo-dark.webp" height="50px" width="100%" style={{ maxHeight: '50px', minWidth: '60px', marginTop: '-10px', marginBottom: '-10px' }} /></Navbar.Brand>}
                    {currTheme === 'light' && <Navbar.Brand href="/"><img alt="company logo" aria-label="Home Page Navigation Button" src="/static/peterfence-only-logo.webp" height="50px" width="100%" style={{ maxHeight: '50px', minWidth: '60px', marginTop: '-10px', marginBottom: '-10px' }} /></Navbar.Brand>}
