...
const About: NextPage = () => {
    const [values, setValues] = useState({
        message1: 'Coming from a farming background, we have been manufacturing and supplying the highest quality wooden fencing not just for the agricultural and rural communities but also for the modern gardener intending to secure property boundaries in style and with ease.',
        ...
        message3: 'According to both the British Standards Institution (BSI) and the Commonwealth Standards Network (CSN), Acacia is the only European timber species that falls under Use Class 4 and is accordingly suitable for outdoor use in contact with soil and fresh water since it exhibits good elasticity in terms of stiffness, flexural strength and environmental impact resistance, as per European Standard BS EN 335-2013. Please note, Use Class 3 woods such as chestnut, oak and teak can also be used outdoors but they are not to come in contact with soil.',
        message4: 'The natural durability of Acacia’s heartwood against wood-destroying agents such as wood decay fungi, insects, marine borers and bacteria has been tested and assessed (considered in  BS EN 350). In fact, it is the chemical substances found in Acacia trees – polyphenols (more specifically, flavonoids) and radical scavengers that give the wood its natural durability and make it resistant to biological degradation.',
        message5: 'Acacia’s natural durability, mechanical strength and aesthetic qualities make it perfect for creating outdoor green spaces, decking, gardening, horticulture, viticulture, arboriculture, agriculture, equestrian fencing, horseback riding, hunting and other outdoor sports facilities, interior carpentry, flooring, wall panels and coverings, cladding.',
        ...
        message9: 'If have decided to collaborate with us, please contact us for more information. Thank you.'
    });
